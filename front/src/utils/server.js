...
//公共路径
let portUrl = "http://39.104.80.226:6500/api/v1.0/";
// let portUrl = "https://owapi.huayanhuayu.cn:6500/api/v1.0/";
// let portUrl = "http://"+window.location.host+"/port/";//change the path!
...
axios.interceptors.request.use(
  config => {
    ...
    // config.headers['Authorization'] = 'Bearer ' + "eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJpYXQiOjE2MjQwNjU1NTcsIm5iZiI6MTYyNDA2NTU1NywianRpIjoiN2Y4Yzc3NTgtY2NkOC00NjQxLWFmODctOTg0ZWNiYTJjNWY1IiwiZXhwIjoxNjI0MTUxOTU3LCJpZGVudGl0eSI6MSwiZnJlc2giOmZhbHNlLCJ0eXBlIjoiYWNjZXNzIn0.-3sRyzFFh9IqK5xqU_TIdPBCdzHa0GHKMpyJn6VNRv8"
    return config
  },
  error => {
...
//获取头部图像ok
// export const getHeadImg = async (callback) =>{
//     let url = portUrl+"headpic-info-all";
//     axios.get(url).then(num => {
//         callback && callback(num.data);
//     })
// }

export const getHeadImg =async () =>{
    let url = portUrl+"headpic-info-all";
    return axios({
        method:'post',
        url:url,
...
//获取前6热门课程ok
// const getHotClass =async (callback) =>{
//     let url = portUrl+"hotcourse";
//     axios.get(url).then(num => {
//         callback && callback(num.data);
//     })
// }
...
export const getCourseAll =async () =>{
    let url = portUrl+"course-info-hot";
    // axios.get(url).then(num => {
...
export const getCooperate =async () =>{
    let url = portUrl+"cooperate-all";
    return axios({
        method:'post',
        url:url,
        headers: {
...
export const getTeacherAll = async () =>{
    let url = portUrl+"teacher-info-all";
    return axios({
        method:'post',
        url:url,
        headers: {
...
export const getHotInfo = async () =>{
    let url = portUrl+"article-info-all";
    return axios({
        method:'post',
        url:url,
        headers: {
...
//获取学生反馈ok
const getFeedback = async (callback) =>{
    let url = portUrl+"feedback";
    axios.get(url).then(num => {
        callback && callback(num.data);
    })
}
...
//获取品牌优势ok
const getBrandAdv = async (callback) =>{
    let url = portUrl+"brandadv";
    axios.get(url).then(num => {
        callback && callback(num.data);
    })
}
...
//获取一类课程前11热门课程ok
const getHotClass_Type = async (type,callback) =>{
    let url = portUrl+"hotclass_type?type="+type;
    axios.get(url).then(num => {
        callback && callback(num.data);
    })
}
...
//获取一类课程的所有课程ok
const getAllClass_Type = async (type,callback) =>{
    let url = portUrl+"allclass_type?type="+type;
    axios.get(url).then(num => {
        callback && callback(num.data);
    })
}
...
//获取某课程的详细信息ok
const getClassDetail = async (classid,callback) =>{
    let url = portUrl+"classdetail?classid="+classid;
    axios.get(url).then(num => {
        callback && callback(num.data);
    })
}
...
//获取相关课程ok
const getRelativeClass = async (classid,callback) =>{
    let url = portUrl+"relativeclass?classid="+classid;
    axios.get(url).then(num => {
        callback && callback(num.data);
    })
}
...
//获取教研团队ok
const getAllProfessor = async (callback) =>{
    let url = portUrl+"allprofessor";
    axios.get(url).then(num => {
        callback && callback(num.data);
    })
}
...
//获取教师团队ok
const getAllTeacher = async (callback) =>{
    let url = portUrl+"allteacher";
    axios.get(url).then(num => {
        callback && callback(num.data);
    })
}
...
//获取一类资讯的所有资讯ok
const getAllInfo_Type = async (type,callback) =>{
    let url = portUrl+"allinfo_type?type="+type;
    axios.get(url).then(num => {
        callback && callback(num.data);
    })
}
...
//获取某资讯的详细信息ok
const getInfoDetail = async (infoid,callback) =>{
    let url = portUrl+"infodetail?infoid="+infoid;
    axios.get(url).then(num => {
        callback && callback(num.data);
    })
}
...
//获取相关资讯ok
const getRelativeInfo = async (infoid,callback) =>{
    let url = portUrl+"relativeinfo?infoid="+infoid;
    axios.get(url).then(num => {
        callback && callback(num.data);
    })
}
...
//获取某一合作信息ok
const getCooperate_Type = async (type,callback) =>{
    let url = portUrl+"cooperate_type?type="+type;
    axios.get(url).then(num => {
        callback && callback(num.data);
    })
}
